...
/**
 * About component, introduces howler and what it does, also provides images
 * @return {Element} about div
 */
function About() {
  return (
    <div id="about">
      ...
      <p>
        ...
        designed to create a safe space for students to discuss mental health
         issues and seek support from their peers.After creating and verifying
         your UW account, you can start sharing your thoughts and feelings
         with other Huskies. Howler is organized into different Packs,
         which group students of similar interests. While anyone can browse
         through the forums of Howler, only verified UW students can post,
         comment, or make new Packs. This means that any content you see
         on Howler is verified to be an actual University of Washington student.
      </p>
